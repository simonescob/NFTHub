...
function StepCard(props: IStepCard) {
  ...
  return (
    <div className={`flex flex-column flex-wrap ${ imageDirection === 'right' ? 'lg:flex-row-reverse' : 'lg:flex-row' } justify-between w-[85%]`}>
      <div className="lg:w-1/2 flex items-center">
        <img src={image.src} />
      </div>
      <div className="lg:w-1/2 flex flex-col justify-start items-start space-y-8 p-10">
